...
import { retreats } from "@/src/lib/retreats";

export default function RetreatGallery() {
  return (
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden rounded-[22px]">
                  <Image
                    ...
                    className={`object-cover transition-transform duration-500 group-hover:scale-[1.015] ${retreat.imagePosition}`}
                  />
                </div>
