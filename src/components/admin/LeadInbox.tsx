...
export default function LeadInbox({ orderRequests, newsletterSubscriptions, programReservations, retreatInquiries }: LeadInboxProps) {
  const [activeTab, setActiveTab] = useState<"orders" | "newsletter" | "programs" | "retreats">("orders");
